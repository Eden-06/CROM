...
class FormalCromInheritanceGenerator extends AbstractCROMGenerator {
	...
	//		MessageDialog.openInformation(shell, "Generator for Formal Model", transformation);
	//
	//	//		val transformation = s;
	//	//		val n=path.removeFileExtension().addFileExtension("py");
